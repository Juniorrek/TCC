...
public class ProjetoController {
    ...
    public String projetosVizualizarGet(Projeto projeto, Model model, HttpServletRequest request) throws REngineException, IOException, FileNotFoundException, ClassNotFoundException, SQLException {
        Gson g = new Gson();
